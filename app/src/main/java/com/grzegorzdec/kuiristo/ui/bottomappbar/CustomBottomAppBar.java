...
package com.grzegorzdec.kuiristo.ui.bottomappbar;
 ...
 * attached {@link FloatingActionButton}. A FAB is anchored to {@link CustomBottomAppBar} by calling
 ...
 * ExtendedFloatingActionButton} with a {@link CustomBottomAppBar}, so there is limited support for that
 * use case. {@link ExtendedFloatingActionButton} can be anchored to the {@link CustomBottomAppBar}, but
 ...
 * CustomBottomAppBar}. {@link #FAB_ALIGNMENT_MODE_CENTER} mode is the primary mode with the FAB is
 ...
 */
public class CustomBottomAppBar extends Toolbar implements AttachedBehavior {
  ...
  @FabAnimationMode int fabAnimationMode;
  private boolean hideOnScroll;
  private final CustomBottomAppBarTopEdgeTreatment topEdgeTreatment;
  ...
  interface AnimationListener {
    void onAnimationStart(CustomBottomAppBar bar);
    void onAnimationEnd(CustomBottomAppBar bar);
  }

  /**
   * If the {@link FloatingActionButton} is actually cradled in the {@link CustomBottomAppBar} or if the
   * {@link FloatingActionButton} is detached which will happen when the {@link
   * FloatingActionButton} is not visible, or when the {@link CustomBottomAppBar} is scrolled off the
   * screen.
   */
  ...
  public CustomBottomAppBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    topEdgeTreatment =
        new CustomBottomAppBarTopEdgeTreatment(fabCradleMargin, fabCornerRadius, fabVerticalOffset);
  ...
  /**
   * Returns true if the {@link CustomBottomAppBar} should hide when a {@link
   * androidx.core.view.NestedScrollingChild} is scrolled. This is handled by {@link
   * CustomBottomAppBar.Behavior}.
   */
  ...
  /**
   * Sets if the {@link CustomBottomAppBar} should hide when a {@link
   * androidx.core.view.NestedScrollingChild} is scrolled. This is handled by {@link
   * CustomBottomAppBar.Behavior}.
   */
  ...
  /** Animates the {@link CustomBottomAppBar} so it hides off the screen. */
  public void performHide() {
    getBehavior().slideDown(this);
  }

  /** Animates the {@link CustomBottomAppBar} so it is shown on the screen. */
  ...
  private float getFabTranslationY(boolean targetAttached) {
    ...
    float attached = getCradleVerticalOffset() - fabHeight / 2 - fabBottomShadow + fab.getPaddingBottom();
  ...
  /**
   * Sets the fab diameter. This will be called automatically by the {@link CustomBottomAppBar.Behavior}
   * if the fab is anchored to this {@link CustomBottomAppBar}.
   */
  ...
  private CustomBottomAppBarTopEdgeTreatment getTopEdgeTreatment() {
    return (CustomBottomAppBarTopEdgeTreatment)
  ...
  /**
   * Behavior designed for use with {@link CustomBottomAppBar} instances. Its main function is to link a
   * dependent {@link FloatingActionButton} so that it can be shown docked in the cradle.
   */
  public static class Behavior extends HideBottomViewOnScrollBehavior<CustomBottomAppBar> {

    private final Rect fabContentRect;

    private WeakReference<CustomBottomAppBar> viewRef;

    private final OnLayoutChangeListener fabLayoutListener = new OnLayoutChangeListener() {
      @Override
      public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft,
          int oldTop, int oldRight, int oldBottom) {
        CustomBottomAppBar child = viewRef.get();
    ...
    public boolean onLayoutChild(
            CoordinatorLayout parent, CustomBottomAppBar child, int layoutDirection) {
    ...
    public boolean onStartNestedScroll(
        ...
        @NonNull CustomBottomAppBar child,
